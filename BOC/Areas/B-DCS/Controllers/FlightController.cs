...
namespace BOC.Areas.B_DCS.Controllers
{
    ...
    public class FlightController : Controller
    {
        ...
        public IActionResult M_PassengerList(string ifly_Pax_ID,
                                              ...
                                              string previous)
        {
            string _flightid = HttpContext.Session.GetString("FlightID");
            string _ifly_Pax_ID = ifly_Pax_ID;
                                       ...
                                       string _Action)
        {
            ...
            string uri_DCS_SeatMap_Get_One_Pax = UriConfig.uri_DCS_SeatMap_Get_One_Pax;
            eLib_Comment_New DCS_Passenger_Offload = new DataAPI().GetStringAPI(uri_DCS_SeatMap_Get_One_Pax,
                                                                       HttpContext.Session.GetString("Token"),
                                                                       HttpMethod.Post,
                                                                       false,
                                                                       "ifly_Pax_ID",
